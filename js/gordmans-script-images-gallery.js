var obj = {
    'BywnXD-Scg78p0TznWvf_BqaEzajemRtrCkAksy92FA' : 'key1',    
    '8e31e45f4a0e8959d456ba2914723451b8262337f75bcea2e04ae535491df16d' : 'key2',
    '9G7-wafyUsNQ4y4pu41iiJ-NwDoZDAmBNel1YYxChnY' : 'key3',
    '9ad80b14098bcead9c7de952435e937cc3723ae61084ba8e729adb642daf0251' : 'key4',
    '783f46460ebede7f21f34b84eb80206e27d042af75812821ffbcd17828afee3f' : 'key5',
    'bf1472d64be4609a8f20ff8ffb1063e074d71094323c979d15c011197df58048' : 'key6',
    'wweTVcnKAQRar1hhU0M5rMuMMd10YwuqVjd_Yyylolk' : 'key7'
}
...
function displayPhotos(){
    photoArrayL.forEach((photo)=>{
        ...
        //a_tag.setAttribute('href', photo.links.html);
            href:photo.links.html+'?utm_source=gordmans&utm_medium=referral',
            target:'_blank',
        });
        ...
        const overlay_bg = document.createElement('div');
        overlay_bg.classList.add("bg-"+random_class_number);
        ...
        figure_elem.appendChild(overlay_bg);
